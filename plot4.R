...
# Set plot parameters for number of rows and columns
par(mfrow=c(2,2))

# Make plot - Top left
plot(DF$Time, DF$Global_active_power, ylab='Global Active Power', xlab='', type='l', col='black')

# Make plot - Top right
plot(DF$Time, DF$Voltage, xlab='datetime', ylab='Voltage', type='l', col='black')
